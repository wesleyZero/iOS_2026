...
enum SigFigAudit {
    ...
    static func systemConfigEntries() -> [Entry] {
        [
            ...
            Entry(label: "Citric Acid %vol",          group: "Ratios",  value: "0.786",   sigFigs: 3, isExact: false, notes: "3 DP"),
            Entry(label: "Potassium Sorbate %vol",    group: "Ratios",  value: "0.096",   sigFigs: 2, isExact: false, notes: "⚠️ LOWEST in system — 3 DP but only 2 SF"),
            ...
            Entry(label: "Circle volumeML",     group: "Mold Specs",  value: "2.292",   sigFigs: 4, isExact: false, notes: "3 DP"),
            Entry(label: "New Bear volumeML",   group: "Mold Specs",  value: "4.600",   sigFigs: 4, isExact: false, notes: "3 DP, trailing zeros significant"),
    ...
    static func userInputEntries() -> [Entry] {
        [
            ...
            Entry(label: "Gelatin %",              group: "User Inputs", value: "5.430",   sigFigs: 4, isExact: false, notes: "3 DP"),
            Entry(label: "Terpene PPM",            group: "User Inputs", value: "219.9",   sigFigs: 4, isExact: false, notes: "1 DP"),
            Entry(label: "Flavor Oil %vol",        group: "User Inputs", value: "0.481",   sigFigs: 3, isExact: false, notes: "3 DP"),
            Entry(label: "Color %vol",             group: "User Inputs", value: "0.581",   sigFigs: 3, isExact: false, notes: "3 DP"),
    ...
    static func calculationEntries() -> [Entry] {
        [
            ...
            // Gelatin mix
            Entry(label: "vGelatin = (5.430/100) × vMix",
    ...
    static func fullReport() -> String {
        ...
        lines.append("   1. Potassium Sorbate %vol = 0.096  →  2 SF")
