...
enum MainSection: String, CaseIterable, Identifiable {
    ...
    static let defaultOrder: [MainSection] = [
        .inputSummary, .batchOutput, .batchValidation, .relativeFractions,
            ...
            Button {
                ...
                .background(
                    RoundedRectangle(cornerRadius: CMTheme.buttonRadius, style: .continuous)
                        ...
                        .shadow(color: systemConfig.accent.opacity(0.4), radius: 8, x: 0, y: 4)
                )
            }
            .buttonStyle(CMPressStyle())
            .padding(.horizontal, 16)
                ...
                .background(
                    ZStack {
                        ...
                        Capsule()
                            ...
                            .environment(\.colorScheme, CMTheme.colorSchemeEnvironment)
                            .opacity(0.25)
...
/// Psychedelic Alert 3 — "Liquid Mercury": Rippling concentric rings with a silver-to-cyan
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 18) {
                ...
                ZStack {
                    ...
                    Image(systemName: "drop.fill")
                        ...
                        .shadow(color: Color(red: 0.0, green: 0.85, blue: 0.95).opacity(0.7), radius: 6)
                        .shadow(color: Color(red: 0.78, green: 0.82, blue: 0.90).opacity(0.4), radius: 14)
            ...
            .background(
                ...
                .shadow(color: Color(red: 0.0, green: 0.55, blue: 0.90).opacity(0.5), radius: 25, y: 8)
                .shadow(color: Color(red: 0.0, green: 0.85, blue: 0.95).opacity(ripple * 0.3), radius: 15, y: -4)
            )
...
/// Psychedelic Alert 4 — "Molten Ember": Glowing ember-to-gold radial plasma with
/// honeycomb shimmer, spinning flame icon, ember-particle glow, and warm dissolve text.
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 18) {
                ...
                ZStack {
                    ...
                    Image(systemName: "flame.fill")
                        ...
                        .shadow(color: Color(red: 1.0, green: 0.65, blue: 0.0).opacity(0.8), radius: 8)
                        .shadow(color: Color(red: 0.95, green: 0.25, blue: 0.0).opacity(0.5), radius: 16)
            ...
            .background(
                ...
                .shadow(color: Color(red: 0.70, green: 0.10, blue: 0.0).opacity(0.5), radius: 25, y: 8)
                .shadow(color: Color(red: 1.0, green: 0.65, blue: 0.0).opacity(emberPulse * 0.3), radius: 15, y: -4)
            )
