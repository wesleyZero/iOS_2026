...
struct BatchOutputView: View {
    ...
    private func componentRow(_ comp: BatchComponent) -> some View {
        ...
        let valueColor: Color = isActivationWaterModified ? CMTheme.strawberryRed : CMTheme.textSecondary
                ...
                VStack(spacing: 1) {
                    ...
                    HStack(spacing: 6) {
                        ...
                        Text(String(format: "+%.3f", viewModel.additionalActiveWater_mL))
                            .font(.system(size: 10, design: .monospaced))
                            .foregroundStyle(CMTheme.strawberryRed.opacity(0.8))
                            .frame(width: 70, alignment: .trailing)
                        Text("")
                            .frame(width: 28, alignment: .leading)
                    }
    ...
    private var additionalWaterInput: some View {
        ...
        return HStack(spacing: 6) {
            ...
            Text("mL")
                .font(.system(size: 12, design: .monospaced))
                .foregroundStyle(CMTheme.strawberryRed.opacity(0.7))
                .frame(width: 28, alignment: .leading)
        }
