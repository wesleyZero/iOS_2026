...
struct BatchCalculator {
    ...
    static func calculate(
        ...
        let mCitric = vCitric * SubstanceDensity.citricAcid.gPerML
        ...
        let mSorbate = vSorbate * SubstanceDensity.potassiumSorbate.gPerML
        activationComponents.append(BatchComponent(
        ...
        for color in sortedColors {
            ...
            let mColor   = vColor * SubstanceDensity.foodColoring.gPerML
            activationComponents.append(BatchComponent(
        ...
        for oil in oils {
            ...
            let mOil     = vOil * SubstanceDensity.flavorOil.gPerML
            activationComponents.append(BatchComponent(
        ...
        for terp in terpenes {
            ...
            let mTerp    = vTerp * SubstanceDensity.terpenes.gPerML
            activationComponents.append(BatchComponent(
        ...
        let vActivationWater = waterForCitric + waterForSorbate
        let mActivationWater = vActivationWater * SubstanceDensity.water.gPerML
        activationComponents.append(BatchComponent(
        ...
        let mGelatin      = vGelatin * SubstanceDensity.gelatin.gPerML
        gelatinComponents.append(BatchComponent(
            label: "Gelatin", mass_g: mGelatin, volume_mL: vGelatin, displayUnit: "g"
        ))

        let phi_gel        = systemConfig.gelatinToWaterMassRatio
        let mGelatinWater  = mGelatin * phi_gel
        let vGelatinWater  = mGelatinWater / SubstanceDensity.water.gPerML
        gelatinComponents.append(BatchComponent(
        ...
        let vGlucoseSyrup = mGlucoseSyrup / SubstanceDensity.glucoseSyrup.gPerML
        let vGranulated   = mGranulated   / SubstanceDensity.sucrose.gPerML
        ...
        let mSugarWaterClosed = vSugarWater * SubstanceDensity.water.gPerML
