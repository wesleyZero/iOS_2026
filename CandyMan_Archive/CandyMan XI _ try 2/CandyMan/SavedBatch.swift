...
class SavedBatch {
    ...
    var gelatinMixtureOveragePercent: Double = 0
...
struct SavedBatchDTO: Codable {
    ...
    var gelatinMixtureOveragePercent: Double?
...
extension SavedBatch {
    ...
    static func from(dto: SavedBatchDTO, context: ModelContext) {
        ...
        batch.gelatinMixtureOveragePercent = dto.gelatinMixtureOveragePercent ?? 0
...
extension SavedBatch {
    ...
    var hpActivationMixtureTotal: Double? {
        guard let last = hpColor, let tare = frozenActivationTrayTare else { return nil }
...
extension BatchConfigViewModel {
    func makeSavedBatch(name: String, batchID: String, result: BatchResult, systemConfig: SystemConfig) -> SavedBatch {
        ...
        batch.gelatinMixtureOveragePercent = systemConfig.gelatinMixtureOveragePercent
