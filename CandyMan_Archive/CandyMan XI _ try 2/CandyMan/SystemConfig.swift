...
final class SystemConfig {
    ...
    // MARK: Preservative Solution Concentrations

    /// Mass fraction of citric acid in the premade solution (0.5 = 50/50 by mass).
    var citricAcidSolutionConcentration: Double = 0.50
    /// Mass fraction of potassium sorbate in the premade solution (0.5 = 50/50 by mass).
    var potassiumSorbateSolutionConcentration: Double = 0.50
    ...
    func applySyntheticDataSet2(to viewModel: BatchConfigViewModel) {
        ...
        viewModel.colorsLocked = false
        viewModel.colorCompositionLocked = false
        viewModel.selectedColors[.pink] = 100.0
    ...
    private func factorySettingsJSON() -> [String: Any] {
        ...
        return [
            ...
            "potassiumSorbatePercent": 0.096,
            "citricAcidPercent": 0.786,
            "citricAcidSolutionConcentration": 0.50,
            "potassiumSorbateSolutionConcentration": 0.50,
            "estimatedFinalMixDensity": 1.308509,
            "densityWater": 0.9982,
            "densityGlucoseSyrup": 1.4500,
            "densitySucrose": 1.5872,
    ...
    private func settingsMatch(_ ref: [String: Any]) -> Bool {
        ...
        let doubleKeys = [
            ...
            "citricAcidSolutionConcentration",
            "potassiumSorbateSolutionConcentration",
        ]
    ...
    func settingsToJSON() -> [String: Any] {
        ...
        return [
            ...
            "citricAcidSolutionConcentration": citricAcidSolutionConcentration,
            "potassiumSorbateSolutionConcentration": potassiumSorbateSolutionConcentration,
    ...
    func loadSettings(from json: [String: Any]) {
        ...
        if let v = json["citricAcidSolutionConcentration"] as? Double { citricAcidSolutionConcentration = v }
        if let v = json["potassiumSorbateSolutionConcentration"] as? Double { potassiumSorbateSolutionConcentration = v }
