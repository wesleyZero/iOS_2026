...
struct ErrorAnalysisView: View {
    ...
    private func errorContent(result: BatchResult) -> some View {
        let theoreticalGelatin = result.gelatinMix.totalMass_g
        let theoreticalSugar   = result.sugarMix.totalMass_g
        let theoreticalActive  = result.activationMix.totalMass_g
        let theoreticalFinal   = result.totalMass_g
