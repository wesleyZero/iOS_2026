...
enum AccentTheme: String, CaseIterable, Identifiable {
    ...
    var color: Color {
        switch self {
        case .indigo:   return Color(red: 0.38, green: 0.45, blue: 0.95)
        case .violet:   return Color(red: 0.58, green: 0.39, blue: 0.92)
        case .blue:     return Color(red: 0.25, green: 0.52, blue: 0.96)
        case .cyan:     return Color(red: 0.20, green: 0.68, blue: 0.90)
        case .teal:     return Color(red: 0.24, green: 0.72, blue: 0.67)
        case .mint:     return Color(red: 0.30, green: 0.78, blue: 0.55)
        case .rose:     return Color(red: 0.90, green: 0.40, blue: 0.55)
        case .coral:    return Color(red: 0.95, green: 0.50, blue: 0.38)
        case .amber:    return Color(red: 0.92, green: 0.68, blue: 0.32)
        case .lavender: return Color(red: 0.68, green: 0.55, blue: 0.92)
        }
    }
}
