...
/// Central view model managing batch configuration state.
@Observable
final class BatchConfigViewModel {
    ...
    var highPrecisionMode: Bool = false
    var weightBeakerEmpty: Double? = nil

    // High-precision sub-measurement fields
    // Gelatin Mix breakdown
