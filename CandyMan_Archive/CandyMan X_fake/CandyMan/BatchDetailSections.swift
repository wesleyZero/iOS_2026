        ...
        VStack(spacing: 0) {
            HStack {
                Button {
                    ...
                    HStack {
                        Text("Quantitative Data (Theoretical)").font(.headline).foregroundStyle(systemConfig.accent)
                        Image(systemName: isExpanded ? "chevron.up" : "chevron.down")
                            .font(.system(size: 12, weight: .semibold))
                            .foregroundStyle(Color(white: 0.45))
                        Spacer()
    ...
    private func validationComponentRows(_ items: [SavedBatchComponent]) -> some View {
        ForEach(items.indices, id: \.self) { i in
            HStack {
                ...
                Spacer()
                Text(String(format: "%.3f", items[i].massGrams))
                    .font(.system(size: 11, design: .monospaced)).foregroundStyle(CMTheme.textSecondary)
                    .frame(width: 70, alignment: .trailing)
                Text(String(format: "%.3f", items[i].volumeML))
                    .font(.system(size: 11, design: .monospaced)).foregroundStyle(CMTheme.textSecondary)
                    .frame(width: 70, alignment: .trailing)
            }
                ...
                ForEach(categoryItems.indices, id: \.self) { i in
                    HStack {
                        Text(categoryItems[i].label)
                            ...
                            .lineLimit(1).minimumScaleFactor(0.8)
                        Spacer()
                        Text(String(format: "%.3f", categoryItems[i].massGrams))
                            .font(.system(size: 11, design: .monospaced)).foregroundStyle(CMTheme.textSecondary)
                            .frame(width: 70, alignment: .trailing)
                        Text(String(format: "%.3f", categoryItems[i].volumeML))
                            .font(.system(size: 11, design: .monospaced)).foregroundStyle(CMTheme.textSecondary)
                            .frame(width: 70, alignment: .trailing)
                    }
                    .padding(.horizontal, 20).padding(.vertical, 2)
        ...
        VStack(spacing: 0) {
            HStack {
                Button {
                    ...
                    HStack {
                        Text("Composition Data (Theoretical)").font(.headline).foregroundStyle(systemConfig.accent)
                        Image(systemName: isExpanded ? "chevron.up" : "chevron.down")
                            .font(.system(size: 12, weight: .semibold))
                            .foregroundStyle(Color(white: 0.45))
                        Spacer()
        ...
        ForEach(items.indices, id: \.self) { i in
            HStack {
                Text(items[i].label)
                    ...
                    .lineLimit(1).minimumScaleFactor(0.8)
                Spacer()
                Text(String(format: "%.3f", pct(items[i].massGrams, of: totalMass)))
                    .font(.system(size: 11, design: .monospaced)).foregroundStyle(CMTheme.textSecondary)
                    .frame(width: 70, alignment: .trailing)
                Text(String(format: "%.3f", pct(items[i].volumeML, of: totalVol)))
                    .font(.system(size: 11, design: .monospaced)).foregroundStyle(CMTheme.textSecondary)
                    .frame(width: 70, alignment: .trailing)
            }
            .padding(.horizontal, 20).padding(.vertical, 2)
                ...
                ForEach(categoryItems.indices, id: \.self) { i in
                    HStack {
                        Text(categoryItems[i].label)
                            ...
                            .lineLimit(1).minimumScaleFactor(0.8)
                        Spacer()
                        Text(String(format: "%.3f", pct(categoryItems[i].massGrams, of: totalMass)))
                            .font(.system(size: 11, design: .monospaced)).foregroundStyle(CMTheme.textSecondary)
                            .frame(width: 70, alignment: .trailing)
                        Text(String(format: "%.3f", pct(categoryItems[i].volumeML, of: totalVol)))
                            .font(.system(size: 11, design: .monospaced)).foregroundStyle(CMTheme.textSecondary)
                            .frame(width: 70, alignment: .trailing)
                    }
                    .padding(.horizontal, 20).padding(.vertical, 2)
        ...
        VStack(spacing: 0) {
            HStack {
                Button {
                    ...
                    HStack {
                        Text("Experiment Data").font(.headline).foregroundStyle(systemConfig.accent)
                        Image(systemName: isExpanded ? "chevron.up" : "chevron.down")
                            .font(.system(size: 12, weight: .semibold))
                            .foregroundStyle(Color(white: 0.45))
                        Spacer()
