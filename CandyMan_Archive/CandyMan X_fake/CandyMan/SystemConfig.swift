...
/// Global configuration for mold specifications, densities, and user preferences.
@Observable
final class SystemConfig {
    ...
    // Mixture Overage — extra % to account for spills (display-only, does not affect batch calc)
    var sugarMixtureOveragePercent: Double = 5.0
    var gelatinMixtureOveragePercent: Double = 5.0
    ...
    private func factorySettingsJSON() -> [String: Any] {
        ...
        return [
            ...
            "gelatinMixtureOveragePercent": 5.0,
