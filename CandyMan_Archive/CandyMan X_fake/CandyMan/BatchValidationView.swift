...
struct BatchValidationView: View {
    ...
    var body: some View {
        ...
        VStack(spacing: 0) {
            ...
            volOnlyRow("Total Volume",     volume: targetVol, valueColor: CMTheme.accentWarm)
            ...
            totalRow(label: "Final Mix", mass: finalMixMass, volume: finalMixVol, volColor: CMTheme.accentWarm)
    ...
    private func finePrintNote(overagePct: Double, targetVol: Double) -> some View {
        ...
        pctPart.foregroundColor = UIColor(CMTheme.accentWarm)
        str += pctPart
        ...
        volPart.foregroundColor = UIColor(CMTheme.accentWarm)
        str += volPart
