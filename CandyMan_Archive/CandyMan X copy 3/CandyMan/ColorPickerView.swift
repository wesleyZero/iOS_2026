...
struct ColorPickerView: View {
    ...
    private var sectionHeader: some View {
        HStack {
            Text("Colors").font(.headline).foregroundStyle(systemConfig.accent)
            Button {
                CMHaptic.light()
        ...
        VStack(spacing: 8) {
            ...
            if !viewModel.selectedColors.isEmpty {
                Button {
                    ...
                    let count = Double(viewModel.selectedColors.count)
        ...
        return VStack(spacing: 0) {
            ...
            HStack(alignment: .firstTextBaseline) {
                ...
                HStack(alignment: .firstTextBaseline, spacing: 6) {
                    NumericField(value: colorUseMass ? massBinding : $viewModel.colorVolumePercent, decimals: 3)
