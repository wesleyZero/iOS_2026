    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 12) {
                ...
                VStack(spacing: 0) {
                    HStack {
                        Text("Mold Shape").cmSectionTitle(accent: systemConfig.accent)
                        Spacer()
                    }
                ...
                VStack(spacing: 0) {
                    HStack {
                        Text("Measurements").cmSectionTitle(accent: systemConfig.accent)
                        Spacer()
                ...
                VStack(spacing: 0) {
                    HStack {
                        Text("Result").cmSectionTitle(accent: systemConfig.accent)
                        Spacer()
                    }
                    .padding(.horizontal, 16).padding(.vertical, 12)
