...
struct ShapePickerView: View {
        ...
        VStack(spacing: 8) {
            HStack {
                ...
                if viewModel.activeTemplateID != nil {
                    HStack(spacing: 6) {
                        Text("Info \(Text("saved").foregroundColor(CMTheme.lockRed)) as \(Text(viewModel.activeTemplateName).foregroundColor(CMTheme.lockRed))")
                            .font(.caption)
                    ...
                    Button {
                        ...
                        HStack(spacing: 6) {
                            Text("Info \(canCalculate ? Text("not saved").foregroundColor(CMTheme.lockRed) : Text("not saved")) as template")
                                .font(.caption)
                                .foregroundStyle(CMTheme.textTertiary)
    ...
    private var templateSection: some View {
        VStack(spacing: 8) {
            ...
            if viewModel.activeTemplateID != nil {
                Text("The \(Text(viewModel.activeTemplateName).foregroundColor(CMTheme.lockRed)) template is being used.")
                    .font(.caption)
                    .foregroundStyle(CMTheme.textTertiary)
                    .padding(.horizontal, 16)
                    .padding(.bottom, 10)
