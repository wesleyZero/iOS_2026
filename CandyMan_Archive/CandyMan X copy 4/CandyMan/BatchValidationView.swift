...
struct BatchValidationView: View {
    ...
    var body: some View {
        ...
        VStack(spacing: 0) {
            Button {
                ...
                HStack {
                    Text("Quantitative Data (Theoretical)").cmSectionTitle(accent: systemConfig.accent)
                    Spacer()
            ...
            volOnlyRow("Total Volume",     volume: targetVol, valueColor: systemConfig.designTertiaryAccent)
            ...
            totalRow(label: "Final Mix", mass: finalMixMass, volume: finalMixVol, volColor: systemConfig.designTertiaryAccent)
    ...
    private func finePrintNote(overagePct: Double, targetVol: Double) -> some View {
        ...
        pctPart.foregroundColor = UIColor(systemConfig.designTertiaryAccent)
        str += pctPart
        ...
        volPart.foregroundColor = UIColor(systemConfig.designTertiaryAccent)
        str += volPart
    ...
    var body: some View {
        ...
        VStack(spacing: 0) {
            Button {
                ...
                HStack {
                    Text("Composition Data (Theoretical)").cmSectionTitle(accent: systemConfig.accent)
                    Spacer()
                    CMDisclosureChevron(isExpanded: isExpanded)
                }
                .contentShape(Rectangle())
